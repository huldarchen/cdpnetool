...
- **全量流量查看**：显示所有捕获的网络请求（无论是否匹配规则）
- **开启/关闭捕获**：控制是否监听所有网络请求
- **详情面板**：DevTools 风格的请求响应查看
- **清除历史**：清除已捕获的请求列表

> 💡 **提示**：Network 面板需要先附加目标页面后才能开启捕获
